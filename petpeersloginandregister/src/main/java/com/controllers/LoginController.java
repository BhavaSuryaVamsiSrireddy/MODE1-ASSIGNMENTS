...
public class LoginController {
	...
	public String addPet(@Valid @ModelAttribute("pet") Pets pet,BindingResult result,Model model,RedirectAttributes redirectAttributes,HttpServletRequest request) {
		HttpSession session = request.getSession(false);
		User user = (User) session.getAttribute("validUser");
		int userId = user.getUserId();
